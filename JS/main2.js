...
function setLanguage(lang) {
    ...
    if (lang === 'en') {
        ...
        document.title = `صباغ ورق جدران تركيب ورق جدران خصم 50% | صباغ شاطر ورخيص | صباغ جوتن | صباغ قريب منك | صباغ ورق جدران | صباغ هندي | أشطر صباغ بالكويت | أحسن صباغ بالكويت | صباغ ماهر | رقم صباغ رخيص - 96616761 - صباغ الكويت رخيص | صباغ رخيص بالكويت | صباغ شاطر ورخيص بالكويت | خدمات صباغة مميزة وبأسعار تنافسي`;
    }
}
